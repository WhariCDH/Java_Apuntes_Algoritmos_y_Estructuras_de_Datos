error id: file:///C:/Users/Dayana/OneDrive/Escritorio/Algoritmos%20y%20Estructuras%20de%20Datos/Semana08/Clase02ListaEnlazadaSimple.java:java/io/PrintStream#println(+8).
...
default -> {
System.out.print@@ln("Opción no valida. Se agregara al final por defecto.");
lista.addLast(valor);
}
```

error id: file:///C:/Users/Dayana/OneDrive/Escritorio/Algoritmos%20y%20Estructuras%20de%20Datos/Semana09/Clase02ListaEnlazadaDoble.java:java/util/ArrayList#size().
            ...
            switch (opcion) {
                ...
                case 3:
                    if (valores.isEmpty()) {
                        ...
                        double resta=valores.get(0);   //Esto toma el primer número de la lista y lo guarda en resta.
                        for (int i=1; i<valores.siz@@e(); i++) {

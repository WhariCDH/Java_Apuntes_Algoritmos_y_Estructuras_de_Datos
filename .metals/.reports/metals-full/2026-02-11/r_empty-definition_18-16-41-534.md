error id: file:///C:/Users/Dayana/OneDrive/Escritorio/Algoritmos%20y%20Estructuras%20de%20Datos/Semana09/Clase02ListaEnlazadaDoble.java:java/lang/System#
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 1:
                    ...
                    Syste@@m.out.print("¿Cuantos valores deseas ingresar?: ");
                    n=scanner.nextInt();
                    ...
                    for (int i=0; i<n; i++) {
                        ...
                        valores.add(valor); // Agregar valor a la lista
                    }

error id: file:///C:/Users/Dayana/OneDrive/Escritorio/Algoritmos%20y%20Estructuras%20de%20Datos/Semana11/Clase04Pila.java:java/util/Scanner#nextInt().
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 1:
                    ...
                    Nodo nuevoNodo=new Nodo(url);   //"Nodo()" es el costructor que se esta llamando y " Nodo nuevoNodo=new" es donde se almacenara

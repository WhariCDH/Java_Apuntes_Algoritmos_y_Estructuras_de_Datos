error id: file:///C:/Users/Dayana/OneDrive/Escritorio/Algoritmos%20y%20Estructuras%20de%20Datos/Semana11/Clase03Pila.java:java/lang/String#
...
System.out.println("4. Recorrer pila (mostrarelementos)");
...
break;
case 2: // Pop: Eliminar el elemento superior de la pila
if (!pila.isEmpty()) {
String elementoEliminado = pila.pop();
System.out.println("Elemento eliminado: " +
elementoEliminado);
} else {
System.out.println("La pila esta vacía, no se puede
eliminar ningún elemento.");
}
break;
case 3: // Peek: Mostrar el elemento en la cima
if (!pila.isEmpty()) {
...
break;
case 4: // Recorrer: Mostrar todos los elementos
if (!pila.isEmpty()) {
...
break;
default:
System.out.println("Opcion no valida. Intente de
nuevo.");
break;
}
} while (opcion != 5);
